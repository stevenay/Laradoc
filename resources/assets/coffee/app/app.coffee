@app =
  ...
  init: ->
    ...
    @settings = new app.Settings @store # @store is the parameter

    # They are for documents
    ...
    # @DOC or @DOCS comes from 'docs.js.erb'.
    # it's json array
    if @DOC
      @bootOne()
    else if @DOCS
  ...
  bootAll: ->
    ...
    for doc in @DOCS
      ...
      # @docs.add pushes the doc variable to @docs.models property
    console.log @disabledDocs.models.length
    @docs.sort()
    @disabledDocs.sort()

    # This is the main method
    # console.log @onBootError.bind(@)
